app.controller('KnowledgessharingCtrl', function ($scope, $stateParams, $http, $state, localStorageService, KnowledgessharingSvc, $window, config) {

    var user = JSON.parse(localStorageService.get("user"));
    var limit = 9;
    $scope.maxSize = 5;
    //var cureentKnowledgeSharing;
